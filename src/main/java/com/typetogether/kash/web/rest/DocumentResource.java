...
import com.typetogether.kash.repository.DocumentRepository;
import com.typetogether.kash.service.DocumentService;
...
/**
 * REST controller for managing {@link com.typetogether.kash.domain.Document}.
 */
@RestController
@RequestMapping("/api")
public class DocumentResource {
    ...
    public List<DocumentDTO> getAllDocuments(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
